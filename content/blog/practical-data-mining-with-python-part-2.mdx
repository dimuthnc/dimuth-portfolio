...
In the previous part of [this blog post series](/practical-data-mining-with-python), we discussed on how we can use pandas library for data mining with python. In this post we will discuss how to select best features to be included in a prediction model.
